...
-- Usage: Replace 2026-01-13 with actual date
...
WHERE p.sku_id IS NULL AND o.orders_date = '2026-01-13'
GROUP BY o."sku-id"
...
LEFT JOIN hive.default.warehouse_inventory i 
    ON o."sku-id" = i.sku_id AND i.stock_date = '2026-01-13'
WHERE i.sku_id IS NULL AND o.orders_date = '2026-01-13'
...
WHERE o.orders_date = '2026-01-13'
